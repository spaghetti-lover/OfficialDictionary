...
public class HistoryController extends GeneralController implements Initializable {
    private ArrayList<Word> historyWordTemp = new ArrayList<>();
    private Trie trieHistoryVocab;
    ...
    public void handleHistorySearchBar() {
        ...
        trieHistoryVocab = new Trie();
        trieHistoryVocab.addAll(getCurrentDic().getHistoryVocab());

        ArrayList<Word> wordsWithPrefix = trieHistoryVocab.getAllWordsWithPrefix(input);

        historyWordTemp  = wordsWithPrefix;
