...
public class PlayerController {
    ...
    public void switchToMain(ActionEvent event) {
        ...
        try {
            root = FXMLLoader.load(getClass().getResource("/flashcard/main.fxml"));
    ...
    public void switchToEditor(ActionEvent event) {
        ...
        if (selectedCard != null) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/flashcard/editor.fxml"));
            try {
                root = loader.load();
                ...
                stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                scene = new Scene(root);
                scene.getStylesheets().add("/flashcard/css/editor.css");
                stage.setScene(scene);
    ...
    public void addCardToDeck(ActionEvent event) throws Exception {
        ...
        try {
            ...
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            scene.getStylesheets().add("/flashcard/editor.css");
            stage.setScene(scene);
            new SlideInRight(root).play();
            stage.show();
        } catch (Exception e) {
    ...
    public void toggleStudySession(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/flashcard/studysession.fxml"));
        try {
            root = loader.load();
